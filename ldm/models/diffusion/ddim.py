...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
        ...
        if timesteps is None:
            ...
            subset_end = int(min(timesteps[0] / self.ddim_timesteps.shape[0], 1) * self.ddim_timesteps.shape[0])
            # subset_end = (timesteps+1 * self.ddim_timesteps.shape[0] / self.ddpm_num_timesteps).int()
